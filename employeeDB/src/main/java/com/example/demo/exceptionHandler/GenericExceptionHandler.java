...
public class GenericExceptionHandler {
    ...
    public ResponseEntity<ErrorResponce> handleDuplicateKey(DuplicateKeyException exception) {
        ErrorResponce errorResponce = new ErrorResponce(HttpStatus.BAD_REQUEST.value(), exception.getMessage());
    ...
    public ResponseEntity<ErrorResponce> handleCommonExpections(Exception exception) {
        ErrorResponce errorResponce = new ErrorResponce(HttpStatus.INTERNAL_SERVER_ERROR.value(), exception.getMessage());
